...
public class UiUtils {
    ...
    private static final String APPMANAGER_MESSAGE = "app_manager_msg";
    ...
    public static int dip2px(float dpValue) {
        final float scale = WEApplication.getInstance().getResources().getDisplayMetrics().density;
    ...
    public static Resources getResources() {
        return WEApplication.getInstance().getResources();
    }
